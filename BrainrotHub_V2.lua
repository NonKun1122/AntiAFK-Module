-- Brainrot Hub V2 for Escape Tsunami For Brainrots
-- Created by Manus AI
-- Features: God Mode, Speed Hack, High Jump, Infinite Jump, Anti-AFK
-- Controls: Press RightShift or Click the Brain Icon to Toggle UI
...
local function createToggle(name, default, callback)
    ...
    button.BackgroundColor3 = default and Color3.fromRGB(0, 180, 100) or Color3.fromRGB(180, 50, 50)
    ...
    button.MouseButton1Click:Connect(function()
        enabled = not enabled
        button.BackgroundColor3 = enabled and Color3.fromRGB(0, 180, 100) or Color3.fromRGB(180, 50, 50)
...
-- Helper function to create Sliders (Step based)
...
createToggle("God Mode (ไม่ตาย)", Config.GodMode, function(v) Config.GodMode = v end)
...
print("Brainrot Hub V2 Loaded! Press RightShift or Click Brain Icon to toggle UI.")
